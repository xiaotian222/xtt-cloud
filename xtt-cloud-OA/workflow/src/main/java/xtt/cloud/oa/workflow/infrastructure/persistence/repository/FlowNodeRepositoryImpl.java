...
public class FlowNodeRepositoryImpl implements FlowNodeRepository {
    ...
    public List<FlowNode> findByFlowDefId(Long flowDefId) {
        ...
        List<xtt.cloud.oa.workflow.infrastructure.persistence.pojo.FlowNode> pos =
                flowNodeMapper.findByFlowDefId(flowDefId);
    ...
    @Override
    public Optional<FlowNode> findByFlowDefIdAndOrderNum(Long flowDefId, Integer orderNum) {
        if (flowDefId == null || orderNum == null) {
            return Optional.empty();
        }
        
        xtt.cloud.oa.workflow.infrastructure.persistence.pojo.FlowNode po =
                flowNodeMapper.findByFlowDefIdAndOrderNum(flowDefId, orderNum);
        if (po == null) {
            return Optional.empty();
        }
    ...
    @Override
    public Optional<FlowNode> findFirstNodeByFlowDefId(Long flowDefId) {
        if (flowDefId == null) {
            return Optional.empty();
        }
