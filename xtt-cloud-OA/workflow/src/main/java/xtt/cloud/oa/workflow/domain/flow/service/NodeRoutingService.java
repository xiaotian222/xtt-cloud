...
//
     ...
     * @return 是否可以流转
     */
    boolean canMoveToNextNode(FlowInstance flowInstance, FlowDefinition flowDefinition);
//
//    /**
//     * 检查并行节点是否全部完成（会签模式）
//     *
...
//    boolean anyParallelNodeCompleted(FlowNode node, Long flowInstanceId);
     ...
     *  流转到下一个节点
     */
    void moveToNextNode(FlowInstance flowInstance, FlowDefinition flowDefinition);
