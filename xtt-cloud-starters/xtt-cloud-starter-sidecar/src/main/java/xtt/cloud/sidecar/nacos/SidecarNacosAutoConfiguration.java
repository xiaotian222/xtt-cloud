...
package xtt.cloud.sidecar.nacos;

import xtt.cloud.nacos.NacosDiscoveryProperties;
import xtt.cloud.nacos.NacosServiceManager;
import xtt.cloud.nacos.discovery.NacosDiscoveryAutoConfiguration;
import xtt.cloud.sidecar.SidecarAutoConfiguration;
import xtt.cloud.sidecar.SidecarDiscoveryClient;
import xtt.cloud.sidecar.SidecarProperties;
