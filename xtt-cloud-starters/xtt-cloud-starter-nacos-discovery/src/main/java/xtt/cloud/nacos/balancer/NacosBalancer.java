...
package xtt.cloud.nacos.balancer;
...
import xtt.cloud.nacos.NacosServiceInstance;
import xtt.cloud.nacos.loadbalancer.NacosLoadBalancer;
...
public class NacosBalancer extends Balancer {
	...
	public static ServiceInstance getHostByRandomWeight3(
		...
		List<Instance> nacosInstance = serviceInstances.stream().map(serviceInstance -> {
			...
			// see
			        // xtt.cloud.nacos.discovery.NacosServiceDiscovery.hostToServiceInstance()
