...
package xtt.cloud.stream.binder.rocketmq.integration.outbound;

import java.util.List;

import xtt.cloud.stream.binder.rocketmq.constant.RocketMQConst;
import xtt.cloud.stream.binder.rocketmq.custom.RocketMQBeanContainerCache;
import xtt.cloud.stream.binder.rocketmq.metrics.Instrumentation;
import xtt.cloud.stream.binder.rocketmq.metrics.InstrumentationManager;
import xtt.cloud.stream.binder.rocketmq.properties.RocketMQProducerProperties;
import xtt.cloud.stream.binder.rocketmq.provisioning.selector.PartitionMessageQueueSelector;
import xtt.cloud.stream.binder.rocketmq.support.RocketMQMessageConverterSupport;
