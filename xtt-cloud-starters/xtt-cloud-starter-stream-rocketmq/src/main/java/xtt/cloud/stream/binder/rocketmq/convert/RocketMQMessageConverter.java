...
package xtt.cloud.stream.binder.rocketmq.convert;
...
public class RocketMQMessageConverter extends AbstractMessageConverter {
	 ...
	 */
	    public static final String DEFAULT_NAME = "xtt.cloud.stream.binder.rocketmq.convert.RocketMQMessageConverter";
